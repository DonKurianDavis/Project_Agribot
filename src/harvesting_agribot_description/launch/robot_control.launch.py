...
def generate_launch_description():
    ...
    robot_description = Command(['ros2 param get --hide-type harvesting_bot/robot_state_publisher robot_description'])
    ...
    twist_mux = Node(
            ...
            remappings=[('/cmd_vel_out','/harvesting_bot/diffbot_base_controller/cmd_vel_unstamped')]
        )
