...
class FertilizerGoalExecutor(Node):
    def __init__(self):
        super().__init__('fertilizer_goal_executor')
        
        # Subscribers
        self.create_subscription(PoseStamped, "/fertilizer_bot/goal_location", self.goal_executor, 10)
