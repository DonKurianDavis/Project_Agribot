...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            namespace='/fertilizer_bot/left',package='v4l2_camera',executable='v4l2_camera_node',
            parameters=[{'video_device':'/dev/video0'}]
        ),

        Node(
            namespace='/fertilizer_bot/right',package='v4l2_camera',executable='v4l2_camera_node',
        ...
        #                         #   'config_file':'src/fertilizer_spraying_agribot_description/config/config.yaml',
