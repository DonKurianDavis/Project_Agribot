...
def generate_launch_description():
    ...
    remappings=[
          ('odom','/fertilizer_bot/diffbot_base_controller/odom'),
    ...
    return LaunchDescription([
        ...
        #                 ('/fertilizer_bot/odom', '/fertilizer_bot/visual_odom')]),
    
        Node(
            package = 'depthimage_to_laserscan', namespace = 'fertilizer_bot' ,executable='depthimage_to_laserscan_node', output='screen',
        ...
        Node(
            package= 'tf2_ros', namespace='fertilizer_bot', executable='static_transform_publisher',
            arguments=["0", "0", "0", "0", "0", "0", "map", "fertilizer_bot/odom"],
            output="screen"
        )         
        # Node(
        #     package='robot_localization',executable='ekf_node',namespace="fertilizer_bot",
        #     output='screen',
