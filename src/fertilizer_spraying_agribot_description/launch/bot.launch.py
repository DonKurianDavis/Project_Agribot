...
def generate_launch_description():
    ...
    pkg_path = os.path.join(get_package_share_directory('fertilizer_spraying_agribot_description'))
    xacro_file = os.path.join(pkg_path,'urdf','fertilizer_spraying_agribot.xacro')
